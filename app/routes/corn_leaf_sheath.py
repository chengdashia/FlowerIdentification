...
# 创建蓝图和命名空间
corn_leaf_sheath_bp = Blueprint('corn_leaf_sheath', __name__)
corn_leaf_sheath_ns = Namespace('corn_leaf_sheath', description='filament identify api')
...
@corn_leaf_sheath_ns.route('/analyze', methods=['POST'])
class ImagePredict(Resource):
    @corn_leaf_sheath_ns.doc(
...
# 注册命名空间
api.add_namespace(corn_leaf_sheath_ns)
