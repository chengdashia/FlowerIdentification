...
leaf_sheath_identify_ns = Namespace('leaf_sheath_identify', description='leaf sheath identify api')
...
@leaf_sheath_identify_ns.route('/analyze', methods=['POST'])
class ImagePredict(Resource):
    @leaf_sheath_identify_ns.doc(
...
# 注册命名空间
api.add_namespace(leaf_sheath_identify_ns)
