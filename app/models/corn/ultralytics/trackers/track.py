...
from app.models.corn.ultralytics.utils import IterableSimpleNamespace, yaml_load
from app.models.corn.ultralytics.utils.checks import check_yaml
...
def on_predict_start(predictor: object, persist: bool = False) -> None:
    ...
    if cfg.tracker_type == "botsort" and cfg.with_reid and cfg.model == "auto":
        from app.models.corn.ultralytics.nn.modules.head import Detect
