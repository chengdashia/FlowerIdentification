...
from app.models.corn.ultralytics.utils import emojis


class HUBModelError(Exception):
    """
    Exception raised when a model cannot be found or retrieved from app.models.corn.ultralytics HUB.
    ...
    def __init__(self, message="Model not found. Please check model URL and try again."):
        ...
        This exception is raised when a requested model is not found or cannot be retrieved from app.models.corn.ultralytics HUB.
