...
Usage:
    from app.models.corn.ultralytics.utils.benchmarks import ProfileModels, benchmark
...
from app.models.corn.ultralytics import YOLO, YOLOWorld
from app.models.corn.ultralytics.cfg import TASK2DATA, TASK2METRIC
from app.models.corn.ultralytics.engine.exporter import export_formats
from app.models.corn.ultralytics.utils import ARM64, ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from app.models.corn.ultralytics.utils.checks import IS_PYTHON_3_13, check_imgsz, check_requirements, check_yolo, is_rockchip
from app.models.corn.ultralytics.utils.downloads import safe_download
from app.models.corn.ultralytics.utils.files import file_size
from app.models.corn.ultralytics.utils.torch_utils import get_cpu_info, select_device
...
def benchmark(
    ...
    Examples:
        ...
        >>> from app.models.corn.ultralytics.utils.benchmarks import benchmark
...
class ProfileModels:
    ...
    Examples:
        ...
        >>> from app.models.corn.ultralytics.utils.benchmarks import ProfileModels
