...
from app.models.corn.ultralytics.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from app.models.corn.ultralytics.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
def _log_plots(experiment, trainer) -> None:
    ...
    Examples:
        >>> from app.models.corn.ultralytics.utils.callbacks.comet import _log_plots
...
def on_fit_epoch_end(trainer) -> None:
    ...
    if curr_epoch == 1:
        from app.models.corn.ultralytics.utils.torch_utils import model_info_for_loggers
