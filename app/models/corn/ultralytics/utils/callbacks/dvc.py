...
from app.models.corn.ultralytics.utils import LOGGER, SETTINGS, TESTS_RUNNING, checks
...
def on_train_end(trainer) -> None:
    ...
    Examples:
        ...
        >>> from app.models.corn.ultralytics.utils.callbacks.dvc import on_train_end
