...
from app.models.corn.ultralytics.data.utils import polygons2masks, polygons2masks_overlap
from app.models.corn.ultralytics.utils import LOGGER, colorstr
from app.models.corn.ultralytics.utils.checks import check_version
from app.models.corn.ultralytics.utils.instance import Instances
from app.models.corn.ultralytics.utils.metrics import bbox_ioa
from app.models.corn.ultralytics.utils.ops import segment2box, xywh2xyxy, xyxyxyxy2xywhr
from app.models.corn.ultralytics.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from app.models.corn.ultralytics.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from app.models.corn.ultralytics.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from app.models.corn.ultralytics.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class CutMix(BaseMixTransform):
    ...
    Examples:
        >>> from app.models.corn.ultralytics.data.augment import CutMix
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from app.models.corn.ultralytics.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        if self.hgain or self.sgain or self.vgain:
            ...
            # lut_hue = ((x * (r[0] + 1)) % 180).astype(dtype)   # original hue implementation from app.models.corn.ultralytics<=8.3.78
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from app.models.corn.ultralytics.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        >>> from app.models.corn.ultralytics.data.dataset import YOLODataset
        >>> from app.models.corn.ultralytics.utils import IterableSimpleNamespace
