...
from app.models.corn.ultralytics.hub.auth import Auth
from app.models.corn.ultralytics.hub.session import HUBTrainingSession
from app.models.corn.ultralytics.hub.utils import HUB_API_ROOT, HUB_WEB_ROOT, PREFIX, events
from app.models.corn.ultralytics.utils import LOGGER, SETTINGS, checks
...
def logout():
    ...
    Examples:
        >>> from app.models.corn.ultralytics import hub
        >>> hub.logout()
    """
    SETTINGS["api_key"] = ""
...
def get_export(model_id: str = "", format: str = "torchscript"):
    """
    Retrieve an exported model in the specified format from app.models.corn.ultralytics HUB using the model ID.

    Args:
        model_id (str): The ID of the model to retrieve from app.models.corn.ultralytics HUB.
...
def check_dataset(path: str, task: str) -> None:
    ...
    Examples:
        >>> from app.models.corn.ultralytics.hub import check_dataset
