...
from app.models.corn.ultralytics import __version__
from app.models.corn.ultralytics.cfg import TASK2DATA, get_cfg
from app.models.corn.ultralytics.data import build_dataloader
from app.models.corn.ultralytics.data.dataset import YOLODataset
from app.models.corn.ultralytics.data.utils import check_cls_dataset, check_det_dataset
from app.models.corn.ultralytics.nn.autobackend import check_class_names, default_class_names
from app.models.corn.ultralytics.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from app.models.corn.ultralytics.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
from app.models.corn.ultralytics.utils import (
    ARM64,
    DEFAULT_CFG,
    IS_COLAB,
    LINUX,
...
from app.models.corn.ultralytics.utils.checks import (
    check_imgsz,
    check_is_path_safe,
    check_requirements,
    check_version,
...
from app.models.corn.ultralytics.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from app.models.corn.ultralytics.utils.export import export_engine, export_onnx
from app.models.corn.ultralytics.utils.files import file_size, spaces_in_path
from app.models.corn.ultralytics.utils.ops import Profile, nms_rotated
from app.models.corn.ultralytics.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if imx:
            from app.models.corn.ultralytics.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from app.models.corn.ultralytics.utils.tal import make_anchors
