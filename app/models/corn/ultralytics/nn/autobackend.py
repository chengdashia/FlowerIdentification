...
from app.models.corn.ultralytics.utils import ARM64, IS_JETSON, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
from app.models.corn.ultralytics.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from app.models.corn.ultralytics.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from app.models.corn.ultralytics.nn.tasks import attempt_load_weights
        ...
        # TF GraphDef
            ...
            from app.models.corn.ultralytics.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from app.models.corn.ultralytics.utils.triton import TritonRemoteModel
        ...
        # Any other format (unsupported)
            ...
            from app.models.corn.ultralytics.engine.exporter import export_formats
    ...
    def forward(self, im, augment=False, visualize=False, embed=None, **kwargs):
        ...
        if self.pt or self.nn_module:
            ...
            if hasattr(self.model, 'predict'):
                ...
                # 添加标准参数
                if 'augment' in supported_params:
                    model_kwargs['augment'] = augment
                if 'visualize' in supported_params:
                    model_kwargs['visualize'] = visualize
                if 'embed' in supported_params:
                    model_kwargs['embed'] = embed
            else:
                # 如果没有 predict 方法，使用默认参数
                model_kwargs = {'augment': augment, 'visualize': visualize, 'embed': embed, **kwargs}
            
            y = self.model(im, **model_kwargs)
        ...
        # CoreML
            ...
            if "confidence" in y:
                ...
                # from app.models.corn.ultralytics.utils.ops import xywh2xyxy
