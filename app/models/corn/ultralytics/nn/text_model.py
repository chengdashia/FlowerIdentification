...
from app.models.corn.ultralytics.utils import checks
...
class CLIP(TextModel):
    ...
    Examples:
        >>> from app.models.corn.ultralytics.models.sam import CLIP
        >>> import torch
    ...
    def __init__(self, size, device):
        ...
        Examples:
            >>> import torch
            >>> from app.models.corn.ultralytics.models.sam.modules.clip import CLIP
...
class MobileCLIP(TextModel):
    ...
    def __init__(self, size, device):
        ...
        Examples:
            >>> from app.models.corn.ultralytics.nn.modules import MobileCLIP
            >>> import torch
        ...
        if not Path(file).is_file():
            from app.models.corn.ultralytics import download
