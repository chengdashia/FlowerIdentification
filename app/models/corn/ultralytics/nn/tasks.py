...
from app.models.corn.ultralytics.nn.autobackend import check_class_names
from app.models.corn.ultralytics.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from app.models.corn.ultralytics.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from app.models.corn.ultralytics.utils.checks import check_requirements, check_suffix, check_yaml
from app.models.corn.ultralytics.utils.loss import (
    E2EDetectLoss,
...
from app.models.corn.ultralytics.utils.ops import make_divisible
from app.models.corn.ultralytics.utils.plotting import feature_visualization
from app.models.corn.ultralytics.utils.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from app.models.corn.ultralytics.models.utils.loss import RTDETRDetectionLoss
...
class YOLOEModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=False, without_reprta=False):
        ...
        """
        from app.models.corn.ultralytics.nn.text_model import build_text_model
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from app.models.corn.ultralytics.utils.loss import TVPDetectLoss
...
class YOLOESegModel(YOLOEModel, SegmentationModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from app.models.corn.ultralytics.utils.loss import TVPSegmentLoss
...
def torch_safe_load(weight, safe_only=False):
    ...
    Examples:
        >>> from app.models.corn.ultralytics.nn.tasks import torch_safe_load
        >>> ckpt, file = torch_safe_load("path/to/best.pt", safe_only=True)
    """
    from app.models.corn.ultralytics.utils.downloads import attempt_download_asset
    ...
    try:
        with temporary_modules(
            modules={
                "ultralytics.yolo.utils": "app.models.corn.ultralytics.utils",
                "ultralytics.yolo.v8": "app.models.corn.ultralytics.models.yolo",
                "ultralytics.yolo.data": "app.models.corn.ultralytics.data",
                "ultralytics.nn.tasks": "app.models.corn.ultralytics.nn.tasks",
                "ultralytics.nn.modules": "app.models.corn.ultralytics.nn.modules",
                "ultralytics.nn.modules.block": "app.models.corn.ultralytics.nn.modules.block",
                "ultralytics.nn.modules.head": "app.models.corn.ultralytics.nn.modules.head",
                "ultralytics.nn.modules.conv": "app.models.corn.ultralytics.nn.modules.conv",
                "ultralytics.nn.modules.transformer": "app.models.corn.ultralytics.nn.modules.transformer",
                "ultralytics.nn.modules.utils": "app.models.corn.ultralytics.nn.modules.utils",
                "ultralytics.nn.modules.activation": "app.models.corn.ultralytics.nn.modules.activation",
                "ultralytics.utils.loss": "app.models.corn.ultralytics.utils.loss",
                "ultralytics.utils.ops": "app.models.corn.ultralytics.utils.ops",
                "ultralytics.utils.tal": "app.models.corn.ultralytics.utils.tal",
                "ultralytics.utils.torch_utils": "app.models.corn.ultralytics.utils.torch_utils",
            },
            attributes={
                "ultralytics.nn.modules.block.Silence": "torch.nn.Identity",  # YOLOv9e
                "ultralytics.nn.tasks.YOLOv10DetectionModel": "app.models.corn.ultralytics.nn.tasks.DetectionModel",  # YOLOv10
                "ultralytics.utils.loss.v10DetectLoss": "app.models.corn.ultralytics.utils.loss.E2EDetectLoss",  # YOLOv10
            },
        ):
            if safe_only:
