...
This module provides an interface to the Segment Anything Model (SAM) from app.models.ym.ultralytics, designed for real-time image
...
class SAM(Model):
    ...
    This class provides an interface to the Segment Anything Model (SAM) from app.models.ym.ultralytics, designed for
