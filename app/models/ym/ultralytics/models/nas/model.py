...
Examples:
    >>> from app.models.ym.ultralytics import NAS
...
from app.models.ym.ultralytics.engine.model import Model
from app.models.ym.ultralytics.utils import DEFAULT_CFG_DICT
from app.models.ym.ultralytics.utils.downloads import attempt_download_asset
from app.models.ym.ultralytics.utils.torch_utils import model_info
...
class NAS(Model):
    ...
    This class provides an interface for the YOLO-NAS models and extends the `Model` class from app.models.ym.ultralytics engine.
