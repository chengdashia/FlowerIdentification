...
from app.models.ym.ultralytics.utils import DATASETS_DIR, LOGGER, NUM_THREADS, TQDM
from app.models.ym.ultralytics.utils.downloads import download, zip_directory
from app.models.ym.ultralytics.utils.files import increment_path
...
def convert_coco(
    ...
    Examples:
        >>> from app.models.ym.ultralytics.data.converter import convert_coco
...
def convert_segment_masks_to_yolo_seg(masks_dir, output_dir, classes):
    ...
    Examples:
        >>> from app.models.ym.ultralytics.data.converter import convert_segment_masks_to_yolo_seg
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Examples:
        >>> from app.models.ym.ultralytics.data.converter import convert_dota_to_yolo_obb
    ...
    Notes:
        The input directory structure assumed for dataset:
            ...
            - labels
                ...
                └─ NNN.txt
    """
    from app.models.ym.ultralytics import SAM
    from app.models.ym.ultralytics.data import YOLODataset
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from app.models.ym.ultralytics.data.converter import create_synthetic_coco_dataset
...
def convert_to_multispectral(path, n_channels=10, replace=False, zip=False):
    ...
    from app.models.ym.ultralytics.data.utils import IMG_FORMATS
