...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Examples:
        >>> from app.models.ym.ultralytics.utils.checks import parse_requirements
...
def check_requirements(requirements=ROOT.parent / "requirements.txt", exclude=(), install=True, cmds=""):
    ...
    Examples:
        >>> from app.models.ym.ultralytics.utils.checks import check_requirements
...
def check_yolo(verbose=True, device=""):
    ...
    from app.models.ym.ultralytics.utils.torch_utils import select_device
...
def collect_system_info():
    ...
    from app.models.ym.ultralytics.utils import ENVIRONMENT  # scope to avoid circular import
    from app.models.ym.ultralytics.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    Examples:
        ...
        >>> from app.models.ym.ultralytics.utils.checks import check_amp
        >>> model = YOLO("yolo11n.pt").model.cuda()
        >>> check_amp(model)
    """
    from app.models.ym.ultralytics.utils.torch_utils import autocast
