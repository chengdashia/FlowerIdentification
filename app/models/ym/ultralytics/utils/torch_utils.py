...
def get_cpu_info():
    ...
    from app.models.ym.ultralytics.utils import PERSISTENT_CACHE  # avoid circular import error
...
def strip_optimizer(f: Union[str, Path] = "best.pt", s: str = "", updates: dict = None) -> dict:
    ...
    Examples:
        >>> from pathlib import Path
        >>> from app.models.ym.ultralytics.utils.torch_utils import strip_optimizer
...
def profile(input, ops, n=10, device=None, max_num_obj=0):
    ...
    Examples:
        >>> from app.models.ym.ultralytics.utils.torch_utils import profile
