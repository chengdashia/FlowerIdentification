...
from app.models.ym.ultralytics.data.augment import LetterBox
from app.models.ym.ultralytics.utils import LOGGER, SimpleClass, ops
from app.models.ym.ultralytics.utils.checks import check_requirements
from app.models.ym.ultralytics.utils.plotting import Annotator, colors, save_one_box
from app.models.ym.ultralytics.utils.torch_utils import smart_inference_mode
...
class BaseTensor(SimpleClass):
    ...
    def cuda(self):
        ...
        Examples:
            >>> import torch
            >>> from app.models.ym.ultralytics.engine.results import BaseTensor
            >>> data = torch.tensor([[1, 2, 3], [4, 5, 6]])
            >>> base_tensor = BaseTensor(data, orig_shape=(720, 1280))
            >>> gpu_tensor = base_tensor.cuda()
...
class Masks(BaseTensor):
    ...
    def __init__(self, masks, orig_shape) -> None:
        ...
        Examples:
            >>> import torch
            >>> from app.models.ym.ultralytics.engine.results import Masks
...
class Keypoints(BaseTensor):
    ...
    Examples:
        >>> import torch
        >>> from app.models.ym.ultralytics.engine.results import Keypoints
