...
from app.models.ym.ultralytics.cfg import TASK2DATA, get_cfg, get_save_dir
from app.models.ym.ultralytics.engine.results import Results
from app.models.ym.ultralytics.hub import HUB_WEB_ROOT, HUBTrainingSession
from app.models.ym.ultralytics.nn.tasks import attempt_load_one_weight, guess_model_task, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            model (str | Path): Path or name of the model to load or create. Can be a local file path, a
                model name from app.models.ym.ultralytics HUB, or a Triton Server model.
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from app.models.ym.ultralytics.trackers import register_tracker
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from app.models.ym.ultralytics.utils.tuner import run_ray_tune
