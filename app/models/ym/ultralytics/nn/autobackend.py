...
from app.models.ym.ultralytics.utils import ARM64, IS_JETSON, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
from app.models.ym.ultralytics.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from app.models.ym.ultralytics.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from app.models.ym.ultralytics.nn.tasks import attempt_load_weights
        ...
        # TF GraphDef
            ...
            from app.models.ym.ultralytics.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from app.models.ym.ultralytics.utils.triton import TritonRemoteModel
        ...
        # Any other format (unsupported)
            ...
            from app.models.ym.ultralytics.engine.exporter import export_formats
    ...
    def forward(self, im, augment=False, visualize=False, embed=None, **kwargs):
        ...
        # CoreML
            ...
            if "confidence" in y:
                ...
                # from app.models.ym.ultralytics.utils.ops import xywh2xyxy
