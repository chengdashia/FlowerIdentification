...
from app.models.ym.ultralytics.utils import ASSETS_URL, DEFAULT_CFG_DICT, DEFAULT_SOL_DICT, LOGGER
from app.models.ym.ultralytics.utils.checks import check_imshow, check_requirements
...
class BaseSolution:
    ...
    def __init__(self, is_cli=False, **kwargs):
        ...
        if is_cli and self.CFG["source"] is None:
            ...
            safe_download(f"{ASSETS_URL}/{d_s}")  # download source from app.models.ym.ultralytics assets
